...
%include other pages
\input{./InitialPages/title.tex}
\input{./InitialPages/certificate.tex}
\input{./InitialPages/acknow.tex}
\input{./InitialPages/abstract.tex}
...
\input{./Chapter1/introduction.tex}
	...
	% Breif Description
	% Problem Definition
\input{./Chapter2/analysis.tex} %previously, literature-survey.tex
...
\input{./Chapter3/design.tex}
	...
	% SRS [TO BE ADDED]
\input{./Chapter4/modelling.tex}
	% Rename to "Modelling" [DONE]
	% Data Flow Diagram
	% State Transition Diagram
\input{./Chapter5/system-design.tex}
	% System Architecture
	% UML Diagrams
		% Use Case Diagram
		% Class Diagram
		% Activity Diagram
		% Sequence Diagram
\input{./Chapter6/coding.tex}
	% Algorithm [TO BE ADDED]
	% Technology details used in the project
	% References to Technology
	% Advantages
	% Applications
\input{./Chapter7/result-sets.tex} %previously, system-implementation-plan.tex

%\input{./work-done.tex} %Currently not relevant.
%\input{./future-work.tex} % Currently not relevant.

\input{./Chapter8/testing.tex}
	% Test Plan [TO BE ADDED]
	% Test Cases [TO BE ADDED]
	% Test Results [TO BE ADDED]
\input{./Chapter9/conclusion.tex}
\input{./Chapter10/references.tex}
\input{./EndPages/plagiarism-check.tex}
\input{./EndPages/published-by.tex}
